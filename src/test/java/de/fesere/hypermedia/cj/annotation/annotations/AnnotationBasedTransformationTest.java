...
import de.fesere.hypermedia.cj.annotation.SerializationTestBase;
import de.fesere.hypermedia.cj.annotation.persons.*;
...
public class AnnotationBasedTransformationTest extends SerializationTestBase {
    ...
    private Collection getCollectionWithPerson(BasePerson person) {
        CollectionBuilder personCollectionBuilder = new CollectionBuilder<>(URI.create("http://foobar.de"), new AnnotationBasedTransformer());
